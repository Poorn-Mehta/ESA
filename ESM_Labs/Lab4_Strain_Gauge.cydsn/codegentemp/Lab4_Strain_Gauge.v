// ======================================================================
// Lab4_Strain_Gauge.v generated from TopDesign.cysch
// 09/10/2019 at 13:44
...
module ADC_DelSig_v3_30_4 (
	...
	cy_clock_v1_0
		#(.id("25531ee8-59c0-4267-bcaa-a37d5d9686e0/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("25531ee8-59c0-4267-bcaa-a37d5d9686e0/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("1562500000"),
		  .is_direct(0),
...
module CharLCD_v2_20_5 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("21513574-fa9e-463b-b653-3a1d14320dc0/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("34404ab8-2f2b-4690-b8d4-0bc5d5c333db"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("fef11f22-a469-4bf4-8e23-a85dac55cdbd"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
