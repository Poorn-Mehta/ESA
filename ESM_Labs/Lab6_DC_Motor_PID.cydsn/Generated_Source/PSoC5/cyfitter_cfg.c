...
#define BS_IOPINS0_4_VAL ((const uint8 CYFAR *)0x48000068u)
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT4_AMUX, 0x0304u);
	...
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP0_MX, 0x01070107u);
	CY_SET_XTND_REG32((void CYFAR *)CYREG_OPAMP2_MX, 0x01070107u);
