// ======================================================================
// Lab5_DC_Motor_Current_Control.v generated from TopDesign.cysch
// 09/10/2019 at 19:23
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("e400201b-d530-4ad5-86d6-85f4b3d038da/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// Sample_Hold_v1_40(Power=2, Sample_Clock_Edge=1, Sample_Mode=1, Vdda_Value=5, Vref_Type=1, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Sample_Hold_v1_40, CY_CONFIG_TITLE=SH, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=SH, CY_INSTANCE_SHORT_NAME=SH, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=40, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=SH, )
...
module ADC_SAR_v3_10_6 (
	...
	cy_psoc3_pins_v1_10
		#(.id("ee5f1334-2b7f-4004-abb8-67790a8dc9e2/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    // -- DFF Start --
    reg  cydff_1;
    always @(posedge Net_90)
    begin
        cydff_1 <= ((Net_127 | Net_97)& ~Net_113);
    end
    assign Net_127 = cydff_1;
    // -- DFF End --


    assign Net_98 = ~Net_97;


    assign Net_101 = Net_98 & Net_90;
	...
	cy_psoc3_pins_v1_10
		#(.id("4247b996-7a74-4430-8bbb-d4c6857b4959"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("63561336-3b8f-4c84-b44d-a0e51ad50c8b"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("dbc684f2-9f55-49e0-93a0-857dc88e84f0"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("2bcfa885-e812-4803-9fbb-9d47acc5ec1c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Blanking_net;
	wire [0:0] tmpFB_0__Blanking_net;
	wire [0:0] tmpIO_0__Blanking_net;
	wire [0:0] tmpINTERRUPT_0__Blanking_net;
	electrical [0:0] tmpSIOVREF__Blanking_net;

	cy_psoc3_pins_v1_10
		#(.id("417f8d8f-0ec1-448c-8f0b-5998125e0a03"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Blanking
		 (.oe(tmpOE__Blanking_net),
		  .y({Net_97}),
		  .fb({tmpFB_0__Blanking_net[0:0]}),
		  .io({tmpIO_0__Blanking_net[0:0]}),
		  .siovref(tmpSIOVREF__Blanking_net),
		  .interrupt({tmpINTERRUPT_0__Blanking_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Blanking_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    cy_annotation_universal_v1_0 Supply (
        .connect({
            Net_3
        })
    );
    defparam Supply.comp_name = "Power_v1_0";
    defparam Supply.port_names = "T1";
    defparam Supply.width = 1;
