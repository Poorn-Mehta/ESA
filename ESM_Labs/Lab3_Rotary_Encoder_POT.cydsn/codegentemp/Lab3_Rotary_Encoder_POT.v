// ======================================================================
// Lab3_Rotary_Encoder_POT.v generated from TopDesign.cysch
// 09/10/2019 at 19:10
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a9005575-3292-4ab2-97ac-d21bcecc5709/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("b0585159-abf9-4633-bbe7-33125e3ec672/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b0585159-abf9-4633-bbe7-33125e3ec672/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_clock_v1_0
		#(.id("b7048a1c-42d1-422a-ab49-857084d092b2"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__P4_0_net;
	wire [0:0] tmpIO_0__P4_0_net;
	wire [0:0] tmpINTERRUPT_0__P4_0_net;
	electrical [0:0] tmpSIOVREF__P4_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		P4_0
		 (.oe(tmpOE__P4_0_net),
		  .y({1'b0}),
		  .fb({Net_36}),
		  .io({tmpIO_0__P4_0_net[0:0]}),
		  .siovref(tmpSIOVREF__P4_0_net),
		  .interrupt({tmpINTERRUPT_0__P4_0_net[0:0]}),
		  .annotation({Net_1}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P4_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__P4_1_net;
	wire [0:0] tmpIO_0__P4_1_net;
	wire [0:0] tmpINTERRUPT_0__P4_1_net;
	electrical [0:0] tmpSIOVREF__P4_1_net;

	cy_psoc3_pins_v1_10
		#(.id("7d26ec84-458c-4bdb-9776-3a140ba69431"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		P4_1
		 (.oe(tmpOE__P4_1_net),
		  .y({1'b0}),
		  .fb({Net_34}),
		  .io({tmpIO_0__P4_1_net[0:0]}),
		  .siovref(tmpSIOVREF__P4_1_net),
		  .interrupt({tmpINTERRUPT_0__P4_1_net[0:0]}),
		  .annotation({Net_2}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__P4_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("744408d5-4f70-44f8-9403-46e801b9a6c8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__P1_7_net;
	wire [0:0] tmpFB_0__P1_7_net;
	wire [0:0] tmpIO_0__P1_7_net;
	wire [0:0] tmpINTERRUPT_0__P1_7_net;
	electrical [0:0] tmpSIOVREF__P1_7_net;

	cy_psoc3_pins_v1_10
		#(.id("d1d749ad-278c-4cd2-a10a-0918f19a9a35"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		P1_7
		 (.oe(tmpOE__P1_7_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__P1_7_net[0:0]}),
		  .io({tmpIO_0__P1_7_net[0:0]}),
		  .siovref(tmpSIOVREF__P1_7_net),
		  .interrupt({tmpINTERRUPT_0__P1_7_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P1_7_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
