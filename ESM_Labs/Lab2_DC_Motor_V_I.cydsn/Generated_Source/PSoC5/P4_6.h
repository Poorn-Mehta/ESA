...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the P4_6_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(P4_6__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in P4_6_SetInterruptMode() function.
     *  @{
     */
        #define P4_6_INTR_NONE      (uint16)(0x0000u)
        #define P4_6_INTR_RISING    (uint16)(0x0001u)
        #define P4_6_INTR_FALLING   (uint16)(0x0002u)
        #define P4_6_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define P4_6_INTR_MASK      (0x01u) 
#endif /* (P4_6__INTSTAT) */
...
/* SIO registers */
#if defined(P4_6__SIO_CFG)
    #define P4_6_SIO_HYST_EN        (* (reg8 *) P4_6__SIO_HYST_EN)
    #define P4_6_SIO_REG_HIFREQ     (* (reg8 *) P4_6__SIO_REG_HIFREQ)
    #define P4_6_SIO_CFG            (* (reg8 *) P4_6__SIO_CFG)
    #define P4_6_SIO_DIFF           (* (reg8 *) P4_6__SIO_DIFF)
#endif /* (P4_6__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define P4_6_0_INTTYPE_REG 		(* (reg8 *) P4_6__0__INTTYPE)
#endif /* (P4_6__INTSTAT) */
