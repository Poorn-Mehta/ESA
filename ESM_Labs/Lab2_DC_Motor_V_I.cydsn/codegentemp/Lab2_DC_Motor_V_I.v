// ======================================================================
// Lab2_DC_Motor_V_I.v generated from TopDesign.cysch
// 09/10/2019 at 19:04
...
module ADC_SAR_v3_10_1 (
	...
	cy_psoc3_pins_v1_10
		#(.id("09308a8a-dfdb-4297-858c-dda0886b035b/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("f01a7888-f3df-4a90-9d5b-0a2f0c588806/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("b3df6672-603b-4598-abf7-cf94a8f1c361"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("111f8583-0367-4b7f-a13c-93386f8a1a67"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("70d67089-3d2a-4b1f-85a9-be97586776c7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("bc8fa705-93a6-4021-9e5f-27ee9e63b00e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
