...
*
* \funcusage
*  \snippet P4_5_SUT.c usage_P4_5_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet P4_5_SUT.c usage_P4_5_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet P4_5_SUT.c usage_P4_5_Read  
*******************************************************************************/
...
* preferred P4_5_Read() API because the 
* P4_5_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet P4_5_SUT.c usage_P4_5_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: P4_5_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use P4_5_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - P4_5_0_INTR       (First pin in the list)
    *  - P4_5_1_INTR       (Second pin in the list)
    *  - ...
    *  - P4_5_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet P4_5_SUT.c usage_P4_5_SetInterruptMode
    *******************************************************************************/
    void P4_5_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & P4_5_0_INTR) != 0u) 
		{ 
			 P4_5_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet P4_5_SUT.c usage_P4_5_ClearInterrupt
    *******************************************************************************/
