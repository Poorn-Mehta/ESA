...
//    ADC_SAR_2_Start();
    ...
    uint16_t Vdrop, Vcounts, Rdrop, Rcounts, Current, loop_counter, Constant, Vmotor, RPM;
...
//        CyDelay(((100-Duty_Cycle)*10)/100);
        ...
        if(loop_counter > 29)
        {
            ...
            LCD_Position(0, 3);
            LCD_PrintString(".");
            if((Vmotor%1000) < 10) LCD_PrintString("00");
            ...
            LCD_Position(0, 10);
            if(Current < 1000) LCD_PrintString("0");
            else LCD_PrintU32Number(Current/1000);
